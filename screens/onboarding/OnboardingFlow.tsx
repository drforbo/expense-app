...
import { Step4QuickGuide } from './Step4QuickGuide';
import { Step5ConnectBank } from './Step5ConnectBank';
import { Step6Loading } from './Step6Loading';
import { Step7FirstCategorization } from './Step7FirstCategorization';
import { Step8MiniWin } from './Step8MiniWin';
import { Step9Pricing } from './Step9Pricing';
  ...
  const renderStep = () => {
    ...
    switch (currentStep) {
      ...
      case 4:
        return (
          <Animated.View style={[styles.stepContainer, animatedStyle]}>
            <Step4QuickGuide onNext={() => goToNextStep({})} />
          </Animated.View>
        );
      case 5:
        return (
      ...
      case 6:
        return (
          <Animated.View style={[styles.stepContainer, animatedStyle]}>
            <Step6Loading onComplete={() => goToNextStep({})} />
          </Animated.View>
        );
      case 7:
        return (
      ...
      case 9:
        return (
          <Animated.View style={[styles.stepContainer, animatedStyle]}>
            <Step9Pricing onNext={(plan) => handleComplete({ plan })} />
          </Animated.View>
        );
      default:
        return null;
